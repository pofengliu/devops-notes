...
- 另外像是 unit-test coverage，它在 CI 流程中的確重要，因為連最基本測試都不足夠，談什麼持續整合呢？把這事做好，更重要的是可以看出員工對改變 (digital transformation) 的意願，以及能與給予員工一個這公司有**在做長期規劃**的願景與想像！還有最近很熱門的 Co-pilot，連總經理都在問是否要加大導入的規模以及導入後對生產力所帶來的影響及 ROI。對於 RD 生產力的指標，
