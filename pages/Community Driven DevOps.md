...
- ## DevOps Evangelist 經驗分享
	...
	- ![image.png](../assets/image_1698469943866_0.png)
	  Figure. [DevOpsDays Taipei 2023](https://devopsdays.tw/2023/#speaker)
	...
	- ### DevOps Evangelist & Faiths
		- #### 信仰來源
			...
			- ##### 解決身邊不合理的流程
				- ![](https://speakerd.s3.amazonaws.com/presentations/8e24732701ff45af870421e9abd29e4a/slide_7.jpg){:height 378, :width 657}
			...
			- ==當然這些不合理、沒有效率的事情在今天要講的單主幹開發裡面，它幾乎不存在！==當理解了背後的原理，我就決定要去推廣所這謂 DevOps 的 Elite culture。
		...
		- #### 軟體公司的數字化轉型?
		  id:: 65103e74-3540-4ece-a12d-6660a99bc609
			- ##### 能力、競爭力與公司文化
			...
			- ##### 快速交付是種「能力」！
				...
				- 這邊我們看到 SpaceX 每天可以在 production release 一萬七千多次，他們試錯成本這麼高且每個火箭造價動輒上百萬美元，甚至有的上面還坐了人呢！他們公司內講的是 DevOps 跟 continuous testing ！另外，特斯拉也是用 SCRUM、講 Agile，可是你看人家生產線上的 sprint 是以五個小時為單位，有些工作站的節點甚至是以三個小時為一個 sprint。所以當我在聽這些 podcast 或conference 的時候，==發現他們談的 DevOps, Agile 跟 Scrum 裡面的核心原理跟做法與我們學到的完全一模一樣，但差別在於他們能夠將這些核心原則做到極致，強調更頻繁的發佈頻率以及要縮短 cycle time 最重要的就要先去除中間不必要的浪費！==
		...
		- #### Automation Strategies
		  id:: 65103e74-5c75-4b1e-b692-2811467093f6
			- ##### 快速反饋中的測試驅動的開發
		...
		- ##### Unit test and dashboards
		  id:: 65103e74-d3ce-478f-8e76-c904e59a3cdd
			- ![](https://files.speakerdeck.com/presentations/8e24732701ff45af870421e9abd29e4a/slide_26.jpg)
			  ...
			  ![](https://files.speakerdeck.com/presentations/8e24732701ff45af870421e9abd29e4a/slide_29.jpg){:height 395, :width 687}
...
- ### Takeaway
	...
	- #### Trunk-based or NOT
		...
		- 只要能夠熟練這些關鍵能力，那是不是主幹開發也只不過是彈指之間的距離罷了。那彈指之間，AE 跟 QA 就少了一半了嗎，還是全消失了？ 當然沒有，反而他們更有時間在做 Explore Testing 跟優化（optimize）整個 Pipeline 的效率。當那天真的來臨時，你確定你能說出一套探索測試的理論亦或是你能夠清楚地察覺到當前 Pipeline 的瓶頸在哪裡，所以你才有辦法去優化它嗎？這才是我們要花時間培養及專注的地方。當趨勢已經改變，你就應該往前看，This is the way！
...
- Your Choice
	...
	- 對於 DevOps evangelist，從單元測試到可觀測性、或是自動化縮短 lead-time 到組織效率都是你的守備範圍，如果操這麼多心只是想要做到中庸等級，那不如就當個工程師就好！簡報重點是希望大家能把精力轉移到 DevOps elite culture 所擘劃的那樣一個情境，慢慢地花時間在「快 」所需要的基礎打好上面，例如單元測試、需求探索方法等等。