		...
		- #### Automation Strategies
			- ##### 快速反饋中的測試驅動的開發
				...
				- ![](https://files.speakerdeck.com/presentations/8e24732701ff45af870421e9abd29e4a/slide_21.jpg)
				  ...
				  這邊想要強調的是基於兩週交付一次，二週內讓所有 regression tests 變成綠色的，跟次 commit 都要在 PR 內跑完大部份的 regression 而且一天要跑 25次、50次，還要超快且 non-flaky，所用的心態、策略、工具與作法完全不一樣。更多詳見[[什麼是自動化測試的標的？]]
				  * 在 PR 內跑完大部份 regression：Test isolations, TestContainers
