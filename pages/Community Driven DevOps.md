	...
	- #### History, Progress & What We Learned
		...
		- ##### Unit test and dashboards
			- ![](https://files.speakerdeck.com/presentations/8e24732701ff45af870421e9abd29e4a/slide_26.jpg)
			  ...
			  這個是現在跟8個月前，所有TW projects coverage screenshots 的圖，我把兩張疊在一起。這包含所有的 repositories，其中一些 bot, utils, backend CMS 那些你不會花太多時間寫測試的 repo，所以平均下來 coverage 會比較低 但是所要看的是在沒有要求及格分數的狀況下且經過了幾年之後，大家還是能自動自發做到持續改善，這是想當不容易的，也代表 [自主團隊文化] autonomous team culture 的成型~~
