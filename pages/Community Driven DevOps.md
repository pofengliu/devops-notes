...
- ### Takeaway
	...
	- #### Trunk-based or NOT
		- ![](https://files.speakerdeck.com/presentations/8e24732701ff45af870421e9abd29e4a/slide_38.jpg)
		  現在的我覺得對於是否實施單主幹開發與否的考量並不如培養關鍵能力重要，這些能力包括解耦代碼部署與發布、分階段推出（Canary Release）和規模化 A/B 測試以降低每次實驗的成本。
		- 只要能夠熟練這些關鍵能力所以彈指間，AE 跟 QA 就少了一半了嗎，還是全消失了？ 當然沒有，反而他們更有時間在做 Explore Testing 跟優化（optimize）整個 Pipeline 的效率。所以真的那天到來的時候，你確定你能說出一套探索測試的理論亦或是你能夠清楚地察覺到當前 Pipeline 的瓶頸在哪裡，所以你才有辦法去優化它嗎？這才是我們要花時間培養及專注的地方。當趨勢已經改變，你就應該往前看，This is the way！
