...
- Your Choice
	...
	- 對於 DevOps evangelist，從單元測試到可觀測性、或是自動化縮短 lead-time 到組織效率都是你的守備範圍，如果操這麼多心只是想要做到中庸等級，那不如就當個 RD 就好！簡報重點是希望大家能把精力轉移到 DevOps elite culter 所擘劃的那樣一個情境，慢慢地花時間在「快 」所需要的基礎打好上面，例如單元測試、需求探索方法等等。