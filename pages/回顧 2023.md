## 總結
	- ### 豐收的一年
	  ...
	  今年 TF 的成果也在 ITHome 所舉辦的幾場研討會上做了三場次的經驗分享 (其中兩場還是早上的 keynote) ，題目包含了 "Community Driven DevOps"，"Engineering Operations with Faros BI" 和 "[Feature Toggle Makes Development More Efficient](https://k8s.ithome.com.tw/2023/session-page/2339)"。
