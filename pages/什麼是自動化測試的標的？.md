...
- ## 團隊能了解自動化測試的內容
	...
	- 另外如何讓測試覆蓋 (Test Coverage) 不重複，請參考：
	  建議可以看看這篇[](https://pipelinedriven.org/article/a-pipeline-friendly-layered-testing-strategy-amp-recipe-for-dev-and-qa)
	- # A PIPELINE FRIENDLY LAYERED TESTING STRATEGY
-
- ## 關鍵實例 V.S. 一般測試案例
-
- ## 如何做自動化測試
