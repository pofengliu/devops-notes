...
- ## 實例化需求對我們帶來的幫助
	...
	- ### 對 CI Pipeline 的信心
	  ...
	  #+END_QUOTE
	  一樣的，今天 pipeline 檢查了很多東西，但大家還是沒有信心，為何呢？ 因為沒有一個人真正了解整個測試的內容！RD 的 unit test，QA 的 integration test，都是沒有充分溝通的狀況下，各別自由發揮，以至於到後來彼此都不知道對方的做了些什麼，有什麼沒做，就連 Service QA 或 PM 也都無法掌握。而實例化需求所帶來團隊對產品需求的共識與針對 key examples 所自動
