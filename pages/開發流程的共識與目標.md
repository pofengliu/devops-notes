...
- ### Performance Metrics
	- [The four key metrics](https://itrevolution.com/measure-software-delivery-performance-four-key-metrics/): 
	  ...
	  * Change fail rate
	- 要專注的點並非要如何讓數字變得好看，而是背後能改善這些指標的 "technical practices"！從底層去實踐真正的 CI/CD、主幹開發、架構彈性、可觀測性等等的工法才是落實 DevOps 文化與精神。圖中所列出的 "technical practices" 其實背後都有資料模型已佐證這些工法的落實是對
- ## 結論
